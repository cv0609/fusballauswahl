...
<section class="fusball_leagues matches-details">
    <div class="container">
        ...
        <div class="fusball_leagues-inner">
            ...
            <h2>{{ $matchDetails[0]->league->year ?? ''}} Jahreszeit</h2>
            ...
            <div class="tab-content-wrapper">
                <div class="toggle-target">
                    <a href="#" class="tab active" data-toggle-target=".tab-content-1">Verteidiger</a>
                    <a href="#" class="tab" data-toggle-target=".tab-content-2">Angreifer</a>
                    <a href="#" class="tab" data-toggle-target=".tab-content-3">Torwart</a>
                    <a href="#" class="tab" data-toggle-target=".tab-content-4">Mittelwart</a>
                </div>
                    ...
                    <div class="fusball_leagues-inner-content">
                        <div class="matches-table matche-det">
                            <table>
                                <thead>
                                    <tr>
                                        <th scope="col" class="">Ausgewählt von</th>
                                        <th scope="col">Team</th>
                                        <th scope="col">Alter </th>
                                        <th scope="col">Verletzt</th>
                                    </tr>
                                </thead>
                                <tbody>
